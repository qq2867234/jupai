...
function Swipe(container, options) {
  ...
  var events = {
    ...
    start: function(event) {
      ...
      var next= $(window.event.srcElement).closest("figure").next().find("img")[0];
      if(null!=next&&typeof(next)!="undefined"){
    	  if(null==next.src||next.src==""||next.src.indexOf("defult.jpg")>-1){
    		  next.src=next.alt;
