...
var showTip = function(tip, time){
	 ...
	 if(typeof(tip) != "undefined"&&tip!=''){
		 ...
		 if(typeof(tiparticle) != "undefined")
			 tiparticle.remove();
		 var html='<article id="article_showTip" class="tc-ar" style="position:fixed; top:50%; z-index:100000000000; width:100%; text-align:center;"><b style="padding:20px 25px; background:#000; border-radius:3px;opacity:0.8;color:#fff">'+tip+'</b></article>';
		 context.append(html);
